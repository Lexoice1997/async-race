...
const Winners = () => {
    ...
    const [carsWin, setCarsWin] = (0, react_1.useState)([]);
    ...
    function fetchCars() {
        return __awaiter(this, void 0, void 0, function* () {
            const responseWinners = yield CarService_1.default.getAllWinners(limit, page);
            const totalCount = responseWinners.headers['x-total-count'];
            const responseCars = yield axios_1.default.get('http://127.0.0.1:3000/garage');
    ...
    const getCar = (id) => {
        const car = cars.filter(item => item.id === id);
        return car[0];
    };
    (0, react_1.useEffect)(() => {
        fetchCars();
    ...
    return (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement("ul", { className: "car_list-head" },
            react_1.default.createElement("li", null, "Number"),
            react_1.default.createElement("li", null, "Car"),
            react_1.default.createElement("li", null, "Name"),
            react_1.default.createElement("li", null, "Wins"),
            react_1.default.createElement("li", null, "Best Time")),
        carsWin.map((item, index) => (react_1.default.createElement("ul", { className: "car_list car_list-head", key: item.id },
            react_1.default.createElement("li", null, index + 1),
            react_1.default.createElement("li", null,
                react_1.default.createElement("svg", { version: "1.0", xmlns: "http://www.w3.org/2000/svg", width: "50.000000pt", height: "50.000000pt", viewBox: "0 0 1280.000000 640.000000", preserveAspectRatio: "xMidYMid meet" },
                    react_1.default.createElement("g", { transform: "translate(0.000000,640.000000) scale(0.100000,-0.100000)", fill: getCar(item.id).color, stroke: "none" },
            ...
            react_1.default.createElement("li", null, getCar(item.id).name),
            react_1.default.createElement("li", null, item.wins),
            react_1.default.createElement("li", null, item.time)))),
